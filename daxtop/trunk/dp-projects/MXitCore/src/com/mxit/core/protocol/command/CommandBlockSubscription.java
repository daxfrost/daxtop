...
/** BlockSubscription Command */
public class CommandBlockSubscription extends Command
{
    public String MXitID = "";

    /** Creates a new BlockSubscription Command */
    public CommandBlockSubscription()
    {
        Type = CommandType.BlockSubscription;
    }
